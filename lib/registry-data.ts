...
export const datasets: Dataset[] = [
  {
    ...
    splitRatio: [70, 20, 10],
    tags: ["제조", "자동차", "외관검사"],
    image: "/images/datasets/car-exterior.png",
  ...
  },
  {
    ...
    splitRatio: [80, 10, 10],
    tags: ["OCR", "문서", "텍스트"],
    image: "/images/datasets/document-scan.png",
    task: "OCR",
    dataType: "이미지",
    distribution: [
  ...
  },
  {
    ...
    splitRatio: [70, 15, 15],
    tags: ["예지보전", "시계열", "센서"],
    image: "/images/datasets/sensor-logs.png",
  ...
  },
  {
    ...
    image: "/images/datasets/pcb-defect.png",
    task: "Segmentation",
    dataType: "이미지",
    distribution: [
